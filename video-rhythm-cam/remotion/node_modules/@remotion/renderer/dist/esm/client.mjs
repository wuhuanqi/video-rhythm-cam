...
var logLevelOption = {
  ...
  getValue: ({ commandLine }) => {
    if (commandLine[cliFlag29]) {
      if (!isValidLogLevel(commandLine[cliFlag29])) {
        throw new Error(`Invalid \`--log\` value passed. Accepted values: ${logLevels.map((l) => `'${l}'`).join(", ")}.`);
      }
      return { value: commandLine[cliFlag29], source: "cli" };
    }
    if (logLevel !== "info") {
...
var metadata = {};
var cliFlag30 = "metadata";
var metadataOption = {
  name: "Metadata",
  cliFlag: cliFlag30,
  description: (mode) => {
    if (mode === "ssr") {
      return /* @__PURE__ */ jsxs21(Fragment26, {
        children: [
...
var cliFlag32 = "number-of-gif-loops";
var numberOfGifLoopsOption = {
  name: "Number of GIF loops",
  cliFlag: cliFlag32,
  description: () => {
    return /* @__PURE__ */ jsxs22(Fragment28, {
      children: [
  ...
  getValue: ({ commandLine }) => {
    if (commandLine[cliFlag32] !== undefined) {
      validate(commandLine[cliFlag32]);
      return {
...
var cliFlag33 = "offthreadvideo-cache-size-in-bytes";
...
var value2 = null;
var cliFlag34 = "offthreadvideo-video-threads";
...
var cliFlag35 = "on-browser-download";
...
var overwriteOption = {
  ...
  getValue: ({ commandLine }, defaultValue2) => {
    if (commandLine[cliFlag36] !== undefined) {
      validate2(commandLine[cliFlag36]);
      return {
        source: "cli",
...
var cliFlag39 = "public-license-key";
...
var cliFlag40 = "public-path";
var currentPublicPath = null;
var publicPathOption = {
  name: "Public Path",
  cliFlag: cliFlag40,
  description: () => {
    return /* @__PURE__ */ jsxs30(Fragment36, {
      children: [
...
var scaleOption = {
  ...
  getValue: ({ commandLine }) => {
    if (commandLine[cliFlag42] !== undefined) {
      validateScale(commandLine[cliFlag42]);
      return {
        source: "cli",
...
var DEFAULT5 = false;
var cliFlag43 = "throw-if-site-exists";
...
import { jsx as jsx41, jsxs as jsxs34, Fragment as Fragment41 } from "react/jsx-runtime";
var mediaCacheSizeInBytes = null;
var cliFlag46 = "media-cache-size-in-bytes";
var mediaCacheSizeInBytesOption = {
  name: "@remotion/media cache size",
  cliFlag: cliFlag46,
  description: () => /* @__PURE__ */ jsxs34(Fragment41, {
    children: [
...
var videoCodecOption = {
  ...
  getValue: ({ commandLine }, {
    ...
    const cliArgument = commandLine[cliFlag47];
    if (cliArgument) {
...
import { jsxs as jsxs35, Fragment as Fragment43 } from "react/jsx-runtime";
var cliFlag48 = "webhook-custom-data";
var webhookCustomDataOption = {
  name: "Webhook custom data",
  cliFlag: cliFlag48,
  description: (type) => /* @__PURE__ */ jsxs35(Fragment43, {
    children: [
...
import { jsx as jsx43, jsxs as jsxs36, Fragment as Fragment44 } from "react/jsx-runtime";
...
var preset = null;
var cliFlag49 = "x264-preset";
var DEFAULT_PRESET = "medium";
var x264Option = {
  name: "x264 Preset",
  cliFlag: cliFlag49,
  description: () => /* @__PURE__ */ jsxs36(Fragment44, {
    children: [
